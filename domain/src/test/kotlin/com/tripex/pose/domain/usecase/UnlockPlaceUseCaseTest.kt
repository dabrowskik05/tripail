...
class UnlockPlaceUseCaseTest {
    ...
    @Test
    fun `unlocks revealAround cells for geocoded place`() = runTest {
    ...
    @Test
    fun `empty query fails without calling geocoder`() = runTest {
    ...
    private class FakeH3(
        ...
        override fun revealDisk(lat: Double, lng: Double, k: Int): Set<Long> = cells
