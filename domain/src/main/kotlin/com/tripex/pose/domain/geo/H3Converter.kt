...
/**
 * All hexagonal math for Tripex Pose. Stateless, thread-safe, Android-free.
...
interface H3Converter {
     ...
     */
    fun revealDisk(lat: Double, lng: Double, k: Int = H3Config.DEFAULT_RING): Set<Long>
     ...
     */
    fun revealAround(lat: Double, lng: Double, radiusMeters: Double): Set<Long>
